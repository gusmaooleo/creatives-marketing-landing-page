...
export function CTASection() {
  ...
  return (
    <section className="py-12 w-full flex justify-center items-center px-4 md:px-6">
      ...
      >
        <div className="relative overflow-hidden rounded-[48px] border border-border shadow-sm min-h-[600px] md:min-h-[600px] flex flex-col items-center justify-center duration-500">
          ...
          <div className="relative z-10 px-6 max-w-5xl mx-auto text-center flex flex-col items-center">
            ...
            <h2 className="font-sans text-2xl md:text-4xl lg:text-5xl tracking-tight text-foreground mb-8 leading-[1.05]">
              ...
              , <br />
              design em{" "}
              <span className="text-foreground/80 font-bold">autoridade</span>.
            </h2>

            {/* Description */}
            <p className="text-muted-foreground text-lg md:text-xl max-w-2xl mb-12 leading-relaxed">
              Estratégias de tráfego pago e branding para empresas que não
              aceitam o comum.
            </p>
